...
export const NEW_DATE_REQUEST = 'NEW_DATE_REQUEST'
export const NEW_DATE_SUCCESS = 'NEW_DATE_SUCCESS'
export const NEW_DATE_RESET = 'NEW_DATE_RESET'
export const NEW_DATE_FAIL = 'NEW_DATE_FAIL'
